...
/// methods registered through <c>AIFunctionFactory.Create</c> in <c>PlaygroundAgent</c>.
/// </summary>
public class WeatherTool(ITurnContext turnContext, IConfiguration configuration, ILogger<WeatherTool> logger)
{
