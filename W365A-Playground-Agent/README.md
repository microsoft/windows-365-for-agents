...
A .NET 8 agent sample demonstrating how to build an AI agent that controls a Windows 365 Cloud PC using the [Agent 365 SDK](https://learn.microsoft.com/en-us/microsoft-agent-365/), the [Microsoft 365 Agents SDK](https://github.com/microsoft/agents), and the Windows 365 Computer Use MCP tools.

The agent connects to Microsoft Teams, accepts natural language requests, and autonomously operates a Cloud PC — taking screenshots, navigating browsers, running shell commands, and more.
...
└── src/
    ├── AgentFrameworkSampleAgent.csproj
